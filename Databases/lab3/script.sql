...
DROP TABLE IF EXISTS Reaction_to_sound CASCADE;
...
DROP FUNCTION IF EXISTS update_person_danger_level();
...
CREATE TABLE Reaction_to_sound (
    person_id BIGINT REFERENCES Person(person_id),
...
BEGIN
    IF TG_TABLE_NAME = 'collision' THEN
        upd_person_id := CASE WHEN TG_OP = 'DELETE' THEN OLD.person_id ELSE NEW.person_id END;
...
INSERT INTO Reaction_to_sound(person_id, sound_id) VALUES (1, 1), (2, 1); -- (1,) - Тим, (2,) - Лекси, (,1) - Рычание велоцирапторов
...
INSERT INTO Reaction_to_sound(person_id, sound_id) VALUES (1, 2), (2, 2); -- (1,) - Тим, (2,) - Лекси, (,2) - звон стекла
